...
*/
	...
	//Exercicio 3, letra A, insere um número real em uma estrutura; atribuir o resultado da função à estrutura.
	...
	//Exercicio 3, letra B, aceita uma estrutura e retorna o número real.
